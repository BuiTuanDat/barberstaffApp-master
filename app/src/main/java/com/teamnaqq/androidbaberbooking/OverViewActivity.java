...
public class OverViewActivity extends AppCompatActivity implements IShoppingDataLoadListener {
    ...
    public void onShoppingDataLoadSuccess(List<ShoppingItem> shoppingItemList) {
        MyShoppingItemAdapter adapter = new MyShoppingItemAdapter(getApplication(), shoppingItemList);
